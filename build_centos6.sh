...
export CUDAVER=9.0
docker run -ti --rm -v`pwd`/rpmbuild:/root/rpmbuild -e CUDAVER=${CUDAVER} -e SQAODVER=${SQAODVER} shinmorino/sqaod_buildenv:centos6 bash #-c 'cd /home/build_rpm; ./build_sse2.sh; ./build_avx2.sh'
